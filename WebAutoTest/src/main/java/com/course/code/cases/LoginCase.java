...
import com.course.code.common.LoginCommon;
import com.course.code.utils.ExcelReport;
import com.course.code.utils.ReadExcel;
import com.course.code.utils.SetUp;
...
import static com.course.code.utils.SetUp.getBaseUrl;
...
public class LoginCase {
    ...
    public void setUp() throws Exception {
        ...
        login.setProperty();
        //设置浏览器属性
        ChromeOptions options = SetUp.setChromeOptions();
        //初始化driver
